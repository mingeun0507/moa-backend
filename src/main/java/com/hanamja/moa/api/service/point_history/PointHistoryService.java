...
//    }
    ...
    public DataResponseDto<List<UserPointRankResponseDto>> getUserPointRank(){
        ...
        responseDtos.add(UserPointRankResponseDto.of("FRESHMAN",
                userRepository.findTop20ByRoleAndIsOnboardedAndIsActiveOrderByPointDescNameAsc(Role.ROLE_FRESHMEN, true, true)));
        responseDtos.add(UserPointRankResponseDto.of("SENIORS",
                userRepository.findTop20ByRoleAndIsOnboardedAndIsActiveOrderByPointDescNameAsc(Role.ROLE_SENIOR, true, true)));
